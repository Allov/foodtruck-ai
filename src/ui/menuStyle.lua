local MenuStyle = {
    ...
    FONTS = {
        ...
        DESCRIPTION = love.graphics.newFont(16),  -- Add description font
    ...
    LAYOUT = {
        ...
        MENU_ITEM_HEIGHT = 50,
        SELECTION_OFFSET = -20,
        DESCRIPTION_Y = 400,         -- Add description Y position
        DESCRIPTION_PADDING = 40,    -- Add description padding
        INSTRUCTIONS_BOTTOM_MARGIN = 80  -- Increased from 50 to 80 for more space
    },
